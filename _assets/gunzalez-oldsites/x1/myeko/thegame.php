...
<?php 
$thelast = 5; // to be updated when images are increased
$nw = $thepix;
if ($nw == 1) {
	$nx = $nw + 1;
	$bk = $thelast;
...
<div id="arleft"><a href="thegame.php?thepix=<?php echo $bk ?>"><img src="media/arleft.gif" width="18" height="28" alt="" border="0"></a></div>
<div id="arright"><a href="thegame.php?thepix=<?php echo $nx ?>"><img src="media/arright.gif" width="18" height="28" alt="" border="0"></a></div>
...
<tr>
	<td align="center" valign="middle"><img src="media/content_images/footypix<?php print $thepix ?>.gif" width="320" height="220" alt="" border="0"></td>
</tr>
</table>
