...
if (isset($_GET['example'])) {
	...
	switch ($example) {
		...
		case 5:
			...
			break;	
		case 6:
			$exampleDetails = '<p>Website: Private project, regular jQuery, CSS, HTML, PHP and WordPress, staple ingredients of small to mid-size projects.</p><p class="link"><a href="http://www.bumithomas.com" target="_blank">http://www.bumithomas.com</a></p>';
			$exampleImage = '<img src="folio/bumi.png" alt="Bumi Music" width="610" height="460" />';
			break;	
		case 7:
				...
				<div id="intro">
					<div class="miniSlide">
						<ul>
							...
							<li>likes the iPhone now, and the <span>iPad</span>.</li>
							<li>likes building single page websites, AKA <span>web applications</span></li>
							<li>does have a <span>twitter</span> now, yeah but only for testing.</li>
							...
							<li>lives in north London and is a massive <span>Arsenal</span> fan. Ooo to, Ooo to be..</li>
		...
		<div id="control-slide-container">
			<div id="controls">
				<ul>
					...
					<li><a href="<?php echo $_SERVER["SCRIPT_NAME"] . '?example=6&amp;menuoption=' . $menuoption; ?>" id="bumi"<?php isActive($example, 6, ' class="active"'); ?>>Bumi Music</a></li>
